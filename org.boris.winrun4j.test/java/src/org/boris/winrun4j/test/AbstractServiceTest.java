...
public class AbstractServiceTest
{
    ...
    public static int RegisterService(Properties ini) {
    ...
    public static long RegisterServiceCtrlHandler(String serviceName, Callback callback) {
        long snPtr = NativeHelper.toNativeString(serviceName, true);
        long res = NativeHelper.call(advapi32, "RegisterServiceCtrlHandlerW", snPtr, callback.getPointer());
        Native.free(snPtr);
        return res;
    }
