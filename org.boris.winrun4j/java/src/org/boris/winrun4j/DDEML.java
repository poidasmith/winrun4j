...
public class DDEML
{
    ...
    public static boolean DdeAbandonTransaction(long handle, long conversation, long transaction) {
        return NativeHelper.call(User32.procDdeAbandonTransaction, handle, conversation, transaction) != 0;
    }

    public static ByteBuffer DdeAccessData(long data) {
        long ptr = Native.malloc(4);
        long pb = NativeHelper.call(User32.procDdeAccessData, data, ptr);
    ...
    public static long DdeAddData(long data, byte[] buffer, int len, int offset) {
        ...
        bb.put(buffer, 0, len);
        long res = NativeHelper.call(User32.procDdeAddData, data, ptr, len, offset);
        Native.free(ptr);
        return res;
    }
    ...
    public static long DdeClientTransaction(byte[] data, int len, long conv, long hszItem, int fmt, int type,
        ...
        ByteBuffer bb = Native.fromPointer(ptr, len);
        bb.put(data, 0, len);
        long res = NativeHelper.call(User32.procDdeClientTransaction, ptr, len, conv, hszItem, fmt, type, timeout, 0);
        Native.free(ptr);
        return res;
    }

    public static int DdeCmpStringHandles(long hsz1, long hsz2) {
        return (int) NativeHelper.call(User32.procDdeCmpStringHandles, hsz1, hsz2);
    }
    ...
    public static long DdeConnect(long idInst, String service, String topic, CONVCONTEXT context) {
        ...
        long res = NativeHelper.call(User32.procDdeConnect, idInst, hszService, hszTopic, ptr);
    ...
    public static long DdeConnectList(long idInst, String service, String topic, long convList, CONVCONTEXT context) {
        ...
        long hszTopic = DdeCreateStringHandle(idInst, topic, CP_WINUNICODE);
        long ptr = context == null ? 0 : context.toNative();
        long res = NativeHelper.call(User32.procDdeConnectList, idInst, hszService, hszTopic, convList, ptr);
        DdeFreeStringHandle(idInst, hszService);
        DdeFreeStringHandle(idInst, hszTopic);
        if (ptr != 0)
            Native.free(ptr);
    ...
    public static long DdeCreateDataHandle(long idInst, byte[] data, int len, int offset, long hszItem, int fmt,
        ...
        ByteBuffer bb = Native.fromPointer(ptr, len);
        bb.put(data, 0, len);
        long res = NativeHelper.call(User32.procDdeCreateDataHandle, idInst, ptr, len, offset, hszItem, fmt, afCmd);
        Native.free(ptr);
        return res;
    }
    ...
    public static long DdeCreateStringHandle(long idInst, String str, int codePage) {
        ...
        long res = NativeHelper.call(User32.procDdeCreateStringHandle, idInst, ptr, codePage);
        Native.free(ptr);
        return res;
    }

    public static boolean DdeDisconnect(long conv) {
        return NativeHelper.call(User32.procDdeDisconnect, conv) != 0;
    }

    public static boolean DdeDisconnectList(long convList) {
        return NativeHelper.call(User32.procDdeDisconnectList, convList) != 0;
    }

    public static boolean DdeEnableCallback(long idInst, long conv, int cmd) {
        return NativeHelper.call(User32.procDdeEnableCallback, idInst, conv, cmd) != 0;
    }

    public static boolean DdeFreeDataHandle(long data) {
        return NativeHelper.call(User32.procDdeFreeDataHandle, data) != 0;
    }

    public static boolean DdeFreeStringHandle(long idInst, long hsz) {
        return NativeHelper.call(User32.procDdeFreeStringHandle, idInst, hsz) != 0;
    }
    ...
    public static int DdeGetData(long data, byte[] buffer, int len, int offset) {
        ...
        int res = (int) NativeHelper.call(User32.procDdeGetData, data, ptr, len, offset);
        if (buffer != null) {
            ByteBuffer bb = Native.fromPointer(ptr, len);
            bb.get(buffer, 0, len);
            Native.free(ptr);
    ...
    public static long DdeGetLastError(long idInst) {
        return NativeHelper.call(User32.procDdeGetLastError, idInst);
    }

    public static boolean DdeImpersonateClient(long conv) {
        return NativeHelper.call(User32.procDdeImpersonateClient, conv) != 0;
    }
    ...
    public static boolean DdeKeepStringHandle(long idInst, long hsz) {
        return NativeHelper.call(User32.procDdeKeepStringHandle, idInst, hsz) != 0;
    }

    public static long DdeNameService(long idInst, long hsz1, long hsz2, int afCmd) {
        return NativeHelper.call(User32.procDdeNameService, idInst, hsz1, hsz2, afCmd);
    }

    public static boolean DdePostAdvise(long idInst, long hszTopic, long hszItem) {
        return NativeHelper.call(User32.procDdePostAdvise, idInst, hszTopic, hszItem) != 0;
    }

    public static int DdeQueryConvInfo(long conv, long idTransaction, long convInfo) {
        return (int) NativeHelper.call(User32.procDdeQueryConvInfo, conv, idTransaction, convInfo);
    }

    public static long DdeQueryNextServer(long convList, long convPrev) {
        return NativeHelper.call(User32.procDdeQueryNextServer, convList, convPrev);
    }
    ...
    public static int DdeQueryString(long idInst, long hsz, StringBuffer buffer, int len, int codePage) {
        ...
        int res = (int) NativeHelper.call(User32.procDdeQueryString, idInst, hsz, ptr, len, codePage);
        if (buffer != null) {
    ...
    public static long DdeReconnect(long conv) {
        return NativeHelper.call(User32.procDdeReconnect, conv);
    }

    public static boolean DdeSetUserHandle(long conv, int id, int user) {
        return NativeHelper.call(User32.procDdeSetUserHandle, conv, id, user) != 0;
    }

    public static boolean DdeUnaccessData(long data) {
        return NativeHelper.call(User32.procDdeUnaccessData, data) != 0;
    }
